...
export class BlogDetails extends React.Component<IProps, IState> {
  
  constructor(props: IProps) {
    super(props)
    this.state = { isActive: true } // You can also pass a Quill Delta here
                    ...
                    <div>
                      <div className="text-center">
                        ...
                        <p className="text-muted mb-4">
                          <i className="mdi mdi-calendar me-1" /> 10 Apr, 2020
                        </p>
                      </div>
                      <hr />
                      <div className="text-center">
                        ...
                        <div className="text-muted font-size-14">
                          ...
                          <blockquote className="p-4 border-light border rounded mb-4">
                            <div className="d-flex">
                              <div className="me-3">
                                <i className="bx bxs-quote--left text-dark font-size-24" />
                              </div>
                              <div>
                                <p className="mb-0">
                                  {" "}
